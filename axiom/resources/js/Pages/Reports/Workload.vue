    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900 dark:to-indigo-900 rounded-lg shadow-sm p-6 border border-blue-200 dark:border-blue-800 mb-6">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div>
                            <h3 class="font-semibold text-gray-900 dark:text-gray-100 mb-1">📊 Advanced Task Monitoring</h3>
                            <p class="text-sm text-gray-600 dark:text-gray-400">View real-time dashboards with team workload analysis and task filters</p>
                        </div>
                        <div class="flex gap-2">
                            <Link href="/dashboard-monitor" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition text-sm font-medium">
                                📈 Dashboard
                            </Link>
                            <Link href="/dashboard/workload" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition text-sm font-medium">
                                👥 Workload
                            </Link>
                            <Link href="/dashboard/tasks" class="inline-flex items-center px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition text-sm font-medium">
                                📋 Tasks
                            </Link>
                        </div>
                    </div>
